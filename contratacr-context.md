...
**ALL 7 design-quality passes COMPLETE.** The user-facing app is fully ES/EN bilingual end-to-end; the admin panel is internally consistent (Spanish-only). Lone deferred item: taxonomy *data* names (languages, insurers) still render Spanish in EN — needs `_EN` maps like categories once did.
