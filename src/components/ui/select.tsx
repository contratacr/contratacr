...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      "flex h-10 w-full items-center justify-between rounded-xl border border-[#e5e7eb] bg-white px-4 py-2.5 text-sm text-[#162543]",
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    data-ui="select-item"
    className={cn(
      "relative flex w-full cursor-pointer select-none items-center rounded-lg px-3 py-2 text-sm text-[#162543]",
