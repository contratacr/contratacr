...
export function LanguagesInput({ value, onChange }: Props) {
  ...
  return (
    <div className="relative">
      <div className="flex flex-wrap items-center gap-2 rounded-xl border border-[#e5e7eb] bg-white p-2 focus-within:ring-2 focus-within:ring-[#009FD9] focus-within:border-transparent transition-all">
        {value.map((id) => (
