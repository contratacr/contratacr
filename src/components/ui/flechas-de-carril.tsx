      ...
      {(["izquierda", "derecha"] as const).map((lado) => puede[lado] && (
        <button
          ...
          className={cn(
            ...
            // CON EL DEDO, NINGUNA FLECHA. Estuvo siempre a la vista en
            // táctil, y como vive medio fuera del carril, su otra mitad caía
            // ENCIMA de la primera pastilla: al desplazar, lo que se veía era
            // «‹ )s» —la opción cortada debajo del botón—, que se lee como que
            // la fila se pasó de largo. Justo lo que la flecha venía a evitar.
            // Con el dedo la fila se arrastra sola y los tres carriles que
            // dibujan flechas ya llevan degradado en el borde, que es la señal
            // que usan todas las apps para decir «hay más hacia allá».
