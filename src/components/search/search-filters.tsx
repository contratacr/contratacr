...
export function MobileServiceSearch() {
  ...
  return (
    <div ref={fieldRef} className="relative flex min-w-0 w-full items-center">
      <Search className="pointer-events-none absolute left-3 h-4 w-4 shrink-0 text-[#6b7280]" />
      <input
        type="text"
        value={q}
        ...
        aria-expanded={open}
        aria-autocomplete="list"
        className="h-10 min-w-0 w-full rounded-xl border border-[#e5e7eb] bg-[#f3f4f6] pl-9 pr-9 text-base text-[#111827] placeholder:text-[#6b7280] transition focus:border-[#009FD9] focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#009FD9]/20 sm:text-sm"
      />
      {q && (
