        ...
        <aside className="min-h-0 min-w-0 flex-1 lg:order-3">
          <div className="relative isolate h-full w-full overflow-hidden bg-[#eef2f6] lg:h-[calc(100vh-104px)] lg:rounded-2xl lg:border lg:border-[#e5e7eb] lg:bg-white lg:sticky lg:top-20">
            ...
            <button
              ...
              onClick={() => setShowFilters(true)}
              className="fixed left-3 top-[calc(env(safe-area-inset-top)+5rem)] z-40 inline-flex h-10 items-center justify-center gap-1.5 rounded-full border border-[#e5e7eb] bg-white/95 px-3 text-[13px] font-bold text-[#162543] shadow-[0_8px_24px_rgba(15,23,42,0.16)] backdrop-blur transition-transform active:scale-95 sm:px-3.5 lg:hidden"
            >
