      ...
      {suggestions.length === 0 ? (
        ...
        suggestions.map((s, i) => (
          ...
          >
            ...
            <span className="shrink-0 text-[11px] text-gray-400">{getCategoryGroupLabel(s.groupId, locale)}</span>
          </button>
        ))
      )}
    </div>
  ...
  return (
    <div className="relative mx-auto w-full max-w-xl text-left">
      <form
        ...
        className="flex h-[52px] items-center gap-3 rounded-2xl border border-gray-200 bg-white px-4 shadow-[0_8px_28px_rgba(0,0,0,0.08)] transition-all focus-within:border-[#009FD9] focus-within:ring-2 focus-within:ring-[#009FD9]/20"
      >
