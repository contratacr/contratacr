...
export function DirectChatInbox() {
  ...
  if (loading) return (
    <div className="ccr-delayed-loading flex min-h-[calc(100dvh-153px)] flex-col items-center justify-center gap-2 px-4 text-center lg:min-h-0" aria-busy="true" role="status">
