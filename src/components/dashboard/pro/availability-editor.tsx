        ...
        <div className="m-4 rounded-2xl border border-[#bfe3f5] bg-[#f8fbfe] p-4 sm:m-5 sm:p-5">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            <div className="flex min-w-0 gap-3">
              <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl ccr-caja-icono-plana">
            ...
            <Link
              ...
              className="inline-flex h-10 shrink-0 items-center justify-center gap-2 rounded-full bg-[#009FD9] px-4 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-[#0089bb] focus:outline-none focus:ring-2 focus:ring-[#009FD9] focus:ring-offset-2"
            >
  ...
  return (
    <div className="ccr-availability-modal app-modal-screen fixed inset-0 z-[200] flex items-stretch justify-center p-0 sm:items-center sm:p-4">
      ...
      <div data-ccr-hay-mas={sombrasDelDia.abajo ? "" : undefined} className="ccr-availability-modal-panel app-bottom-sheet relative z-10 flex h-full w-full flex-col overflow-hidden rounded-none bg-white shadow-2xl sm:h-auto sm:max-h-[90vh] sm:max-w-2xl sm:rounded-2xl">
        ...
        <div ref={cuerpoDelDia} className="min-h-0 flex-1 overflow-y-auto overscroll-contain grid grid-cols-1 gap-5 p-4 sm:grid-cols-2 sm:p-5">
