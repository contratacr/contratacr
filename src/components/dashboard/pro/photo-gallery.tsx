        ...
        {shownCases.length > 0 && (
          <div className="flex flex-col gap-1 sm:items-end">
            <button
              ...
              className="flex h-11 w-full items-center justify-center gap-2 rounded-full bg-[#009FD9] px-4 text-sm font-bold text-white transition-colors hover:bg-[#0089bb] sm:w-auto sm:px-6 disabled:cursor-not-allowed disabled:bg-[#cbd5e1] max-sm:[&>svg]:hidden"
            >
