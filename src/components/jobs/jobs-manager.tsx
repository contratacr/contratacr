      ...
      <div className={embedded ? "w-full" : "mx-auto max-w-4xl"}>
        <div className="mb-5 flex flex-col gap-4">
          ...
          <>
            ...
            <Link href="/empleos/publicar?from=panel" className="flex h-11 w-full items-center justify-center gap-2 rounded-full bg-[#009FD9] px-4 text-sm font-bold text-white transition-colors hover:bg-[#0089bb] sm:w-auto sm:self-end sm:px-6 lg:hidden"><Plus className="h-4 w-4" />{copy.publish}</Link>
          </>
        </div>
