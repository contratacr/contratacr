...
export function BackToTop() {
  ...
  return (
    <AppTooltip
      ...
      align="center"
      className={cn(
        "fixed bottom-[calc(1rem+env(safe-area-inset-bottom))] right-4 z-[60] transition-all duration-300 ease-out sm:bottom-6 sm:right-6",
    ...
    >
      <button
        ...
        className="grid h-12 w-12 place-items-center rounded-full p-[2px] text-[#162543] shadow-lg shadow-[#162543]/15 transition-all duration-300 ease-out hover:-translate-y-0.5 hover:shadow-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#009FD9] focus-visible:ring-offset-2 active:translate-y-0 sm:h-12 sm:w-12"
        style={{
