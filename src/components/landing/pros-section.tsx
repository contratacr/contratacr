...
function BroomIcon() {
  return (
    <svg className="h-6 w-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round">
      <path d="M9 5L3 19h18L15 5" /><path d="M9 5h6" /><path d="M9 5c0 0-2 3-2 7h10c0-4-2-7-2-7" />
    </svg>
  );
}
function WrenchIcon() {
...
function RollerIcon() {
  return (
    <svg className="h-6 w-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round">
      <rect x="2" y="2" width="16" height="6" rx="2" /><path d="M10 8v6" /><rect x="7" y="14" width="6" height="4" rx="1" />
    </svg>
  );
}
function HammerIcon() {
...
/* ─── Data ─── */
const CATEGORY_TABS = [
  { id: "limpieza",    label: "Limpieza",     Icon: BroomIcon,   href: "/buscar?categoria=limpieza" },
  { id: "plomeria",    label: "Plomería",     Icon: WrenchIcon,  href: "/buscar?categoria=plomeria" },
  { id: "jardineria",  label: "Jardinería",   Icon: LeafIcon,    href: "/buscar?categoria=jardineria" },
  { id: "mudanzas",    label: "Mudanzas",     Icon: TruckIcon,   href: "/buscar?categoria=mudanzas" },
  { id: "electricidad",label: "Electricidad", Icon: BoltIcon,    href: "/buscar?categoria=electricidad" },
  { id: "pintura",     label: "Pintura",      Icon: RollerIcon,  href: "/buscar?categoria=pintura" },
  { id: "carpinteria", label: "Carpintería",  Icon: HammerIcon,  href: "/buscar?categoria=carpinteria" },
  { id: "tecnologia",  label: "Tecnología",   Icon: MonitorIcon, href: "/buscar?categoria=tecnologia" },
  { id: "mecanica",    label: "Mecánica",     Icon: CarIcon,     href: "/buscar?categoria=mecanica" },
  { id: "seguridad",   label: "Seguridad",    Icon: ShieldIcon,  href: "/buscar?categoria=seguridad" },
];

interface ServiceCard { label: string; href: string; src: string; }
type CategoryMap = Record<string, ServiceCard[]>;

const CATEGORY_CARDS: CategoryMap = {
  limpieza: [
    ...
    { label: "Limpieza de oficinas",    href: "/buscar?categoria=limpieza",   src: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?auto=format&fit=crop&w=600&q=80" },
    ...
    { label: "Lavado de alfombras",     href: "/buscar?categoria=limpieza",   src: "https://images.unsplash.com/photo-1527515637462-cff94eecc1ac?auto=format&fit=crop&w=600&q=80" },
  ],
  plomeria: [
    ...
    { label: "Instalación de baños",    href: "/buscar?categoria=plomeria",   src: "https://images.unsplash.com/photo-1555041469-a586c61ea9bc?auto=format&fit=crop&w=600&q=80" },
    { label: "Tanques de agua",         href: "/buscar?categoria=plomeria",   src: "https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?auto=format&fit=crop&w=600&q=80" },
  ...
  electricidad: [
    ...
    { label: "Tableros y breakers",     href: "/buscar?categoria=electricidad", src: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?auto=format&fit=crop&w=600&q=80" },
    ...
    { label: "Iluminación LED",         href: "/buscar?categoria=electricidad", src: "https://images.unsplash.com/photo-1540932239986-30128078f3c5?auto=format&fit=crop&w=600&q=80" },
  ],
  pintura: [
  ...
  carpinteria: [
    ...
    { label: "Puertas y ventanas",      href: "/buscar?categoria=carpinteria", src: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?auto=format&fit=crop&w=600&q=80" },
  ...
  mecanica: [
    ...
    { label: "Cambio de aceite",        href: "/buscar?categoria=mecanica", src: "https://images.unsplash.com/photo-1558618047-3c8c76f1d8e9?auto=format&fit=crop&w=600&q=80" },
    { label: "Sistema eléctrico",       href: "/buscar?categoria=mecanica", src: "https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?auto=format&fit=crop&w=600&q=80" },
  ],
  seguridad: [
...
export function ProsSection() {
  const [activeId, setActiveId] = useState("limpieza");
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-[#1a2744] leading-tight">
            Pros para cada proyecto en{" "}
            <span className="text-[#2563EB]">Tu Zona.</span>
          </h2>
        </div>

        {/* Icon tabs — horizontal scroll */}
        <div className="relative mb-8">
          <div
            className="flex gap-1 overflow-x-auto pb-3 hide-scrollbar"
            ...
            {CATEGORY_TABS.map((tab) => {
              ...
              return (
                <button
                  ...
                  className="flex flex-col items-center gap-2 px-4 py-3 shrink-0 rounded-xl transition-all duration-200 group"
                  style={{
          ...
          {/* Right fade edge for overflow hint */}
          <div
            className="pointer-events-none absolute right-0 top-0 bottom-3 w-12"
            style={{ background: "linear-gradient(to right, transparent, #f4f7fa)" }}
          />
        </div>
