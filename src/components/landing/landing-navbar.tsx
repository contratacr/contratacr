                  ...
                  <div className="grid grid-cols-2 gap-1.5">
                    {selectedGroup.items.map((item) => (
                      <button
                        ...
                        type="button"
                        onClick={() => go(item.id)}
                        className="group flex min-h-10 items-center justify-between gap-2 rounded-xl px-3 py-2 text-left text-sm font-semibold leading-snug transition-colors hover: hover: focus:outline-none focus-visible:ring-2 focus-visible:ring-[#009FD9]/20 ccr-caja-icono-plana"
                      >
