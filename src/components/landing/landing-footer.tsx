...
const FOOTER_COLUMNS = [
  {
    ...
    links: [
      ...
      { label: "Guías de precios",    href: "/guias/precios" },
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-sm text-gray-400 leading-relaxed mb-2 max-w-[220px]">
              ContrataCR — Consideralo hecho.
            </p>
            <p className="text-xs text-gray-300 leading-relaxed mb-5 max-w-[220px]">
            ...
            <div className="flex items-center gap-2.5">
              {SOCIAL_LINKS.map(({ label, href, Icon }) => (
                <a
                  ...
                  className="w-9 h-9 flex items-center justify-center rounded-xl bg-gray-50 border border-gray-100 text-gray-400 hover:text-[#2563EB] hover:border-[#2563EB]/20 hover:bg-[#EBF5FB] transition-all"
                >
                  <Icon />
                </a>
              ))}
          ...
          {FOOTER_COLUMNS.map((col) => (
            <div key={col.heading}>
              <h3 className="text-xs font-bold uppercase tracking-widest text-[#1a2744] mb-4">
                {col.heading}
              </h3>
        ...
        <div className="border-t border-gray-100 mt-12 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <p className="text-xs text-gray-300">
              © {new Date().getFullYear()} ContrataCR, S.A. Todos los derechos reservados.
            </p>
          </div>
