...
export function AiConcierge({ embedded = false }: { embedded?: boolean } = {}) {
  ...
  return (
    <section
      ...
      className={cn(
        embedded
          ? "relative flex h-[calc(var(--app-visual-viewport-height)_-_4rem)] min-h-[360px] w-full items-stretch justify-stretch overflow-hidden lg:h-[min(780px,calc(100dvh-220px))] lg:min-h-[540px]"
