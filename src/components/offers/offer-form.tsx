...
const OFFER_FORM_COPY = {
  ...
  en: {
    back: "Back",
    backToOffers: "Back to promotions",
    editTitle: "Edit promotion",
    publishTitle: "Post a promotion",
    ...
    pareceEmpleo: "This looks like a job opening, not a promotion. Promotions are deals on what you do; if you are looking to hire someone, it belongs in Jobs, where people apply and you get their résumé.",
    ...
    availabilityHelp: "The promotion will be hidden automatically after this date.",
    location: "Location",
    province: "Province",
    ...
    descriptionError: "Describe the promotion with at least 20 characters.",
    imagesError: "Add at least one promotion image.",
    priceError: "Enter the current promotion price.",
    ...
    databaseUnavailable: "The promotions database is not enabled yet.",
    numericError: "One of the prices or quantities is too high. Review the values entered.",
    saveError: "We could not save the promotion. Review the information and try again.",
    publishError: "We could not publish the promotion.",
