...
export function OffersBoard({
  ...
  return (
    <main className="min-h-[calc(100vh-72px)] overflow-x-clip bg-white pb-16 text-[#162543] lg:flex lg:h-[calc(100dvh-64px)] lg:min-h-0 lg:flex-col lg:overflow-hidden lg:bg-[#fafafa] lg:pb-0">
      ...
      <div className="mx-auto w-full max-w-7xl px-0 sm:px-6 sm:py-5 lg:flex-1 lg:min-h-0 lg:px-6 lg:pb-0 lg:pt-0">
