            ...
            <div className="flex min-w-0 flex-1 flex-col gap-0">
              ...
              <div className="flex min-w-0 items-start gap-2 pr-8 lg:pr-0">
                <Link href={profileHref} className="relative z-10 min-w-0 flex-1">
                  <h3 title={businessName ? businessName : professional.fullName} className="flex min-w-0 items-center gap-0.5 font-bold text-[#111827] text-[15px] leading-[1.1] hover:text-[#009FD9] transition-colors">
