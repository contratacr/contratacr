...
const BASE_CATEGORY_GROUPS: CategoryGroup[] = [
  {
    ...
    emoji: "🏠",
    items: [
      { id: "plomeria", label: "Plomería", keywords: ["plomero", "plomera", "fontanero", "fontanera", "fontaneria", "tuberias", "canerias", "grifo", "fuga", "sanitarios", "agua", "lavamanos", "inodoro"] },
      ...
      { id: "bombas_agua", label: "Bombas de agua", keywords: ["bomba de agua", "bomba sumergible", "tanque de agua", "presion de agua", "hidroneumatico", "sistemas de bombeo", "sistema de bombeo", "estacion de bombeo", "pozo profundo", "bomba industrial"] },
      ...
      { id: "gypsum", label: "Gypsum y drywall", keywords: ["cielo raso", "tabiques", "divisiones", "drywall", "tablaroca", "plycem"] },
      ...
      { id: "cortinas_y_persianas", label: "Cortinas y persianas", keywords: ["cortinas", "persianas", "blackout", "roller", "cortinas enrollables", "persianas verticales", "cortineros", "toldos", "cortinas a la medida"] },
      { id: "reparacion_de_plantas_electricas", label: "Reparación de plantas eléctricas", keywords: ["planta electrica", "plantas electricas", "generador", "generadores", "mantenimiento de generadores", "planta de emergencia", "grupo electrogeno", "transferencia automatica"] },
      { id: "electromecanica", label: "Electromecánica", keywords: ["electromecanico", "servicios electromecanicos", "mantenimiento electromecanico", "motores electricos", "bobinado", "tableros electricos"] },
      { id: "ingenieria_civil", label: "Ingeniería civil", keywords: ["ingeniero", "estructuras", "planos", "calculo estructural", "obra civil"] },
      { id: "ingenieria_electrica", label: "Ingeniería eléctrica", keywords: ["ingeniero electrico", "planos electricos", "diseno electrico", "cargas electricas", "sistema electrico", "planta electrica"] },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "domotica", label: "Domótica y smart home", keywords: ["automatizacion del hogar", "smart home", "IoT", "casa inteligente"] },
      ...
      { id: "reparacion_impresoras", label: "Reparación de impresoras", keywords: ["impresora", "fotocopiadora", "fotocopiadoras", "copiadora", "multifuncional", "toner", "cartucho", "atasco de papel", "mantenimiento impresora"] },
      { id: "venta_sistemas_de_sonido", label: "Sistemas de audio", keywords: ["sistema de sonido", "sistemas de sonido", "parlantes", "bocinas", "amplificador", "venta de sonido", "sonido para local"] },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "automatizacion_industrial", label: "Automatización industrial", keywords: ["plc", "tableros de control", "variadores de frecuencia", "scada", "robotica industrial", "lineas de produccion", "neumatica", "instrumentacion industrial", "automatizacion de procesos"] },
      { id: "sistemas_contra_incendio", label: "Sistemas contra incendios", keywords: ["sistema contra incendio", "contra incendios", "deteccion de incendios", "rociadores", "sprinklers", "hidrantes", "bomba contra incendios", "detectores de humo", "alarma de incendio"] },
      { id: "coaching", label: "Coaching", keywords: ["coach", "coaching profesional", "coaching personal", "mentoria", "desarrollo personal"] },
      { id: "mantenimiento_equipo_medico", label: "Mantenimiento de equipo médico", keywords: ["mantenimiento de equipo medico", "equipos medicos", "equipo dental", "sillon dental", "autoclave", "esterilizador", "rayos x dental", "compresor dental", "calibracion de equipo medico", "mantenimiento preventivo de equipo medico", "reparacion de equipo medico", "ingenieria biomedica", "ingeniero biomedico", "ingenieria medica", "electromedicina", "monitor de signos vitales", "microscopio dental"] },
      { id: "venta_equipo_medico_dental", label: "Venta de equipo médico y dental", keywords: ["venta de equipo medico dental", "equipo medico y dental", "equipo dental", "insumos medicos", "insumos dentales", "suministros medicos", "instrumental medico", "instrumental dental", "distribuidor de equipo medico", "unidad dental", "autoclave", "camillas de examinacion"] },
    ],
  },
  {
    id: "salud",
    ...
    items: [
      ...
      { id: "psicologia", label: "Psicología", keywords: ["psicologo", "psicoterapeuta", "psicoterapia", "terapeuta", "salud mental", "terapia", "counseling", "ansiedad", "depresion", "bienestar emocional"] },
      ...
      { id: "odontologia", label: "Odontología", keywords: ["dentista", "odontologo", "dientes", "muela", "limpieza dental", "ortodoncia", "endodoncia", "caries", "clinica dental", "consultorio dental"] },
      ...
      { id: "medicina_domicilio", label: "Medicina general", keywords: ["doctor", "medico", "medico general", "consulta medica", "medico a domicilio", "visita medica", "medicina general", "consultorio medico", "clinica medica"] },
      { id: "medico_especialista", label: "Médico especialista", keywords: ["especialista medico", "cirujano", "medico cirujano", "cardiologo", "corazon", "dermatologo", "ginecologo", "internista", "traumatologo", "especialidad medica"] },
      { id: "cardiologia", label: "Cardiología", keywords: ["cardiologo", "corazon", "cardiaco", "electrocardiograma", "ecocardiograma", "arritmia", "holter", "prueba de esfuerzo", "cardiopatia", "infarto", "soplo cardiaco", "marcapasos"] },
      ...
      { id: "cuidado_infantil", label: "Cuidado infantil y niñera", keywords: ["ninera", "babysitter", "nanny", "canguro", "cuido de ninos", "guarderia en casa"] },
      ...
      { id: "peluqueria_canina", label: "Peluquería canina y grooming", keywords: ["groomer", "grooming", "bano de mascotas", "estetica canina", "perros", "peluqueria de perros"] },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "unhas", label: "Uñas y manicure", keywords: ["nail tech", "manicure", "pedicure", "unas acrilicas", "gel", "nail art", "semipermanente"] },
  ...
  },
  {
    ...
    emoji: "🚗",
    items: [
      { id: "mecanica", label: "Mecánica automotriz", keywords: ["mecanico", "mecanica", "mecanicos", "mecanico automotriz", "taller mecanico", "taller", "pasos de corriente", "paso de corriente", "bateria descargada", "arrancar el carro", "motor", "frenos", "transmision", "aceite", "servicio de auto"] },
...
const NATURAL_QUERY_ALIASES: Record<string, string[]> = {
  ...
  bombas_agua: ["sistemas de bombeo", "sistema de bombeo", "estacion de bombeo", "necesito una bomba de agua"],
  tiendas_mascotas: ["alimento para mascotas", "comida para perro", "comida para gato", "donde comprar concentrado"],
  cardiologia: ["cardiologo", "ver un cardiologo", "especialista del corazon", "me hacen un electrocardiograma", "revisar el corazon", "cardiologist", "heart specialist"],
  mantenimiento_equipo_medico: ["reparar equipo medico", "arreglar equipo medico", "reparar sillon dental", "arreglar autoclave", "calibrar equipo medico", "mantenimiento de equipo dental", "tecnico de equipo medico", "ingeniero biomedico", "repair medical equipment", "dental chair repair", "service medical equipment"],
  venta_equipo_medico_dental: ["comprar equipo medico", "comprar equipo dental", "donde comprar un autoclave", "vender equipo medico", "buy medical equipment", "dental equipment supplier"],
  redes_internet: [
    "redes",
  ...
  medico_especialista: ["medico especialista", "especialista medico", "medico cirujano", "cirujano", "necesito un cirujano", "dermatologo", "ginecologo", "cardiologo", "traumatologo"],
  ...
  legal: ["abogado", "asesoria legal", "servicios legales", "liberar hipoteca", "liberar hipoteca de carro", "cancelar hipoteca de carro", "levantar hipoteca de carro", "liberar prenda", "cancelar prenda", "cancelacion de prenda", "tramite legal de vehiculo", "registro nacional carro", "abogado para tramite", "lawyer", "attorney", "legal advice", "i need a lawyer"],
  ...
  mecanica: ["arreglar carro", "mecanico para carro", "mecanico en atenas", "revisar motor", "cambio de aceite", "mechanic", "mechanic in atenas", "my car will not start", "car will not start"],
...
export const NATURAL_SERVICE_SCENARIOS: Record<string, string[]> = {
  plomeria: ["se me sale agua debajo del lavamanos"],
  electricidad: ["quiero poner luces nuevas en la cocina"],
  pintura: ["la sala necesita otro color"],
  carpinteria: ["necesito un mueble de madera a la medida"],
  ebanisteria: ["quiero muebles finos para la oficina"],
  techos: ["se mete agua cuando llueve"],
  pisos: ["quiero cambiar la ceramica del apartamento"],
  impermeabilizacion: ["tengo humedad en la pared y quiero sellarla"],
  fumigacion: ["hay cucarachas en la casa"],
  cerrajeria: ["me quede afuera y no abre la puerta"],
  aire_acondicionado: ["el cuarto no enfria"],
  calentadores: ["la ducha ya no calienta"],
  bombas_agua: ["no sube agua al tanque"],
  ventanas_puertas: ["quiero cambiar puertas corredizas"],
  vidrieria: ["se quebro un vidrio grande"],
  soldadura: ["necesito unir unas piezas de metal"],
  herreria: ["quiero rejas para la ventana"],
  gypsum: ["quiero dividir un cuarto con pared liviana"],
  servicio_gas: ["la cocina de gas no prende bien"],
  reparacion_electrodomesticos: ["la lavadora dejo de funcionar"],
  cardiologia: ["necesito un especialista del corazon"],
  cortinas_y_persianas: ["quiero poner cortinas nuevas en la sala"],
  reparacion_de_plantas_electricas: ["la planta electrica no arranca cuando se va la luz"],
  electromecanica: ["se quemo el motor electrico de la maquina"],
  automatizacion_industrial: ["necesito automatizar una linea de produccion"],
  sistemas_contra_incendio: ["hay que instalar rociadores contra incendios en la bodega"],
  venta_sistemas_de_sonido: ["quiero un sistema de sonido para el local"],
  mantenimiento_equipo_medico: ["el sillon dental de la clinica dejo de funcionar"],
  venta_equipo_medico_dental: ["quiero equipar un consultorio dental nuevo"],
  jardineria: ["el patio esta lleno de zacate alto"],
  poda_arboles: ["las ramas estan pegando al techo"],
  paisajismo: ["quiero que el jardin se vea bonito y disenado"],
  limpieza_piscinas: ["el agua de la piscina esta verde"],
  riego_automatizado: ["quiero aspersores automaticos"],
  control_plagas: ["hay hormigueros en el patio"],
  alarmas: ["quiero sensores contra robos"],
  monitoreo_alarmas: ["necesito que vigilen la alarma"],
  cercas_electricas: ["quiero poner electricidad en la cerca"],
  construccion: ["quiero levantar una pared nueva"],
  maestro_obras: ["necesito alguien que supervise la obra"],
  remodelacion: ["quiero cambiar la cocina y el bano"],
  ingenieria_civil: ["necesito calculos y planos estructurales"],
  ingenieria_electrica: ["necesito planos electricos"],
  ...
  lavado_muebles: ["el sofa tiene manchas"],
  limpieza_post_construccion: ["termino la obra y quedo polvo por todo lado"],
  nutricion: ["quiero comer mejor y bajar grasa"],
  psicologia: ["necesito hablar con alguien por ansiedad"],
  psiquiatria: ["creo que necesito medicina para ansiedad"],
  fisioterapia: ["me duele la rodilla despues de correr"],
  odontologia: ["me duele una muela"],
  ortodoncia: ["quiero enderezarme los dientes"],
  pediatria: ["mi bebe necesita control medico"],
  optometria: ["veo borroso y necesito revisar la vista"],
  optica_lentes: ["necesito comprar lentes graduados"],
  enfermeria: ["ocupo que me pongan una inyeccion"],
  medicina_domicilio: ["me siento enfermo y quiero consulta general"],
  medico_especialista: ["tengo una mancha en la piel"],
  laboratorio_clinico: ["ocupo examenes de sangre"],
  ambulancias_privadas: ["necesito trasladar un paciente"],
  terapia_lenguaje: ["mi hijo no pronuncia bien"],
  terapia_ocupacional: ["mi hijo necesita ayuda con motora fina"],
  podologia: ["tengo callos en los pies"],
  cuidado_adultos: ["mi abuelita necesita compania y ayuda"],
  cuidado_discapacidad: ["necesito apoyo para una persona con discapacidad"],
  cuidado_infantil: ["ocupo que cuiden a mi hijo unas horas"],
  coaching: ["quiero mejorar metas y habitos"],
  entrenamiento_personal: ["ocupo entrenar para ponerme fuerte"],
  entrenamiento_deportivo: ["quiero mejorar para jugar futbol"],
  masajes: ["tengo la espalda contracturada"],
  acupuntura: ["quiero terapia con agujas"],
  belleza: ["quiero arreglarme para una fiesta"],
  peluqueria: ["ocupo cortarme el pelo"],
  maquillaje: ["quiero maquillaje para una boda"],
  unhas: ["quiero hacerme acrilicas"],
  pestanas: ["quiero extensiones en los ojos"],
  depilacion: ["quiero quitarme vello"],
  estetica_facial: ["quiero limpieza facial"],
  spa: ["quiero un dia de relajacion"],
  bronceado: ["quiero verme mas bronceada"],
  costura_y_arreglos_de_ropa: ["el pantalon me queda largo"],
  lavanderia: ["tengo mucha ropa para lavar y planchar"],
  zapateria: ["se despego la suela del zapato"],
  relojeria: ["mi reloj se detuvo"],
  joyeria: ["se rompio una cadena de oro"],
  lavado_vehiculos: ["el carro esta muy sucio"],
  mudanzas: ["me cambio de apartamento"],
  fletes: ["ocupo llevar una cama a otra provincia"],
  mensajeria: ["necesito enviar un paquete hoy"],
  transporte_privado: ["ocupo que me lleven al aeropuerto"],
  alquiler_vehiculos: ["quiero alquilar un carro"],
  mecanica: ["el carro hace un ruido en el motor"],
  ...
  grua: ["el carro quedo varado"],
  tecnologia: ["ocupo ayuda con computadoras de la empresa"],
  reparacion_computadoras: ["la laptop esta lentisima"],
  redes_internet: ["el wifi no llega al cuarto"],
  camaras_seguridad: ["quiero ver mi casa desde el celular"],
  domotica: ["quiero controlar luces desde el telefono"],
  desarrollo_web: ["necesito una pagina para mi negocio"],
  diseno_apps: ["quiero una app para clientes"],
  soporte_tecnico: ["la compu de la oficina no conecta"],
  ciberseguridad: ["me preocupa que hackeen mi negocio"],
  consultoria_ti: ["necesito ordenar sistemas de la empresa"],
  reparacion_celulares: ["el celular no carga"],
  reparacion_impresoras: ["la impresora se atasca"],
  impresion_3d: ["quiero fabricar un prototipo plastico"],
  cctv: ["quiero camaras conectadas para vigilancia"],
  control_acceso: ["quiero controlar quien entra al edificio"],
  contabilidad: ["ocupo ayuda con libros contables"],
  legal: ["necesito revisar un contrato"],
  notaria: ["necesito autenticar una firma"],
  auditoria: ["quiero revisar cuentas de la empresa"],
  asesoria_financiera: ["quiero ordenar mis finanzas"],
  corredor_seguros: ["necesito escoger una poliza"],
  asesoria_tributaria: ["hacienda me pide declaraciones"],
  consultoria: ["quiero mejorar mi negocio"],
  traduccion: ["necesito pasar un documento a ingles"],
  recursos_humanos: ["ocupo contratar personal"],
  capacitacion_empresarial: ["quiero capacitar al equipo"],
  gestoria_tramites: ["necesito ayuda con permisos municipales"],
  bienes_raices: ["quiero vender una propiedad"],
  avaluos: ["necesito saber cuanto vale mi casa"],
  consultoria_ambiental: ["necesito permisos de setena"],
  guardas_seguridad: ["ocupo guardas para un local"],
  investigacion_privada: ["necesito investigar a una persona"],
  ...
  ferreterias: ["ocupo tornillos y pintura"],
  papelerias_librerias: ["necesito utiles y copias"],
  carnicerias_verdulerias: ["ocupo carne y verduras"],
  tiendas_mascotas: ["necesito comida para mi perro"],
  diseno_grafico: ["quiero un logo bonito"],
  audio_video: ["ocupo sonido profesional"],
  marketing_digital: ["quiero que mi negocio salga en redes"],
  diseno: ["necesito una ilustracion"],
  publicidad: ["quiero anunciar mi negocio"],
  redaccion_contenido: ["necesito textos para la pagina"],
  fotografia: ["quiero fotos para mi perfil"],
  produccion_video: ["quiero grabar un video para redes", "quiero grabar video para redes"],
  fotografia_eventos: ["ocupo fotos de la boda"],
  videografia: ["quiero video de la boda"],
  organizacion_eventos: ["necesito que me organicen la fiesta"],
  dj_sonido: ["ocupo musica y parlantes"],
  chef: ["quiero comida preparada en mi casa"],
  catering: ["necesito comida para muchos invitados"],
  decoracion: ["quiero decorar el salon"],
  alquiler_mobiliario: ["ocupo mesas y sillas para alquilar"],
  maestro_ceremonias: ["necesito alguien que dirija el evento"],
  floristeria: ["quiero arreglos de flores"],
  animacion_infantil: ["ocupo entretenimiento para ninos"],
  ...
  clases_manejo: ["quiero aprender a manejar"],
  clases_baile: ["quiero aprender salsa"],
  clases_cocina: ["quiero aprender a cocinar"],
  agencia_viajes: ["quiero planear vacaciones"],
  guia_turistico: ["quiero alguien que me ensene un parque nacional"],
  operador_turistico: ["busco tour de un dia"],
  alquiler_vacacional: ["busco una casa para quedarme en la playa"],
  veterinaria: ["mi perro esta enfermo"],
  peluqueria_canina: ["mi perro ocupa bano y corte"],
  cuido_mascotas: ["necesito que paseen a mi perro"],
  transporte_mascotas: ["ocupo llevar mi mascota al veterinario"],
};
...
function termsForCategory(item: CategoryItem & { groupId: string; groupLabel: string }, locale?: string): string[] {
  return [
    ...
    ...(NATURAL_SERVICE_SCENARIOS[item.id] ?? []),
  ];
}
...
export const CATEGORY_LABELS_EN: Record<string, string> = {
  ...
  gypsum: "Gypsum and drywall", servicio_gas: "Gas service",
  ...
  medico_especialista: "Medical specialist",
  cardiologia: "Cardiology", laboratorio_clinico: "Clinical laboratory",
  ...
  cortinas_y_persianas: "Curtains & blinds",
  reparacion_de_plantas_electricas: "Generator repair",
  electromecanica: "Electromechanical services",
  automatizacion_industrial: "Industrial automation",
  sistemas_contra_incendio: "Fire protection systems",
  venta_sistemas_de_sonido: "Audio systems",
  mantenimiento_equipo_medico: "Medical equipment maintenance",
  venta_equipo_medico_dental: "Medical & dental equipment sales",
...
export const HEALTH_CATEGORY_IDS = new Set<string>([
  ...
  "podologia", "acupuntura", "medico_especialista", "cardiologia", "laboratorio_clinico", "ambulancias_privadas",
