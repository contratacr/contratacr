...
const BASE_CATEGORY_GROUPS: CategoryGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "medico_especialista", label: "Médico especialista", keywords: ["especialista medico", "cardiologo", "corazon", "dermatologo", "ginecologo", "internista", "traumatologo", "especialidad medica"] },
