...
function buildMetadata(locale: string): Metadata {
  ...
  return {
    ...
    manifest: "/site.webmanifest?v=original-flat-icon-20260727",
    appleWebApp: {
      capable: true,
      title: "ContrataCR",
    ...
    icons: {
      icon: [
        ...
        { url: "/favicon-96x96.png?v=original-flat-icon-20260727", type: "image/png", sizes: "96x96" },
      ],
      apple: [{ url: "/apple-touch-icon-original-flat.png?v=20260727", sizes: "180x180" }],
    },
    openGraph: {
      type: "website",
      siteName: "ContrataCR",
