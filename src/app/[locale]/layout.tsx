...
function buildMetadata(locale: string): Metadata {
  ...
  return {
    ...
    manifest: "/site.webmanifest?v=flat-brand-icon-20260726",
    appleWebApp: {
      capable: true,
      title: "ContrataCR",
    ...
    icons: {
      icon: [
        ...
        { url: "/favicon-96x96.png?v=flat-brand-icon-20260726", type: "image/png", sizes: "96x96" },
      ],
      apple: [{ url: "/apple-touch-icon.png?v=flat-brand-icon-20260726", sizes: "180x180" }],
    },
    openGraph: {
      type: "website",
      siteName: "ContrataCR",
