  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#f5f8fb]">
      ...
      <main className="ccr-notifications-page-main flex w-full flex-1 flex-col px-0 pb-0 pt-16 sm:px-6 sm:pb-16 sm:pt-24 lg:px-8">
        <section className="ccr-notifications-page-panel mx-auto w-full max-w-5xl flex-1 bg-white px-4 pb-4 pt-2 sm:flex-none sm:rounded-2xl sm:border sm:border-[#dfe8f0] sm:p-6 sm:shadow-sm">
