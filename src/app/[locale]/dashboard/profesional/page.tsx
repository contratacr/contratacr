          ...
          <div className={cn("mx-auto mb-6 w-full max-w-[79.5rem]", mobileSectionOpen ? "hidden lg:block" : "block")}>
            ...
            <div className="grid min-w-0 grid-cols-[auto_minmax(0,1fr)] items-center gap-3 sm:grid-cols-[auto_minmax(0,1fr)_auto] sm:gap-5">
              ...
              <div className="min-w-0 self-center">
                ...
                <div data-testid="dashboard-identity-actions" className="mt-2 flex min-h-[32px] items-end justify-between gap-3 sm:mt-1 sm:min-h-[22px] sm:justify-start">
                  ...
                  {publicProfileHref && (
                    <Link
                      ...
                      className="mb-px inline-flex h-4 shrink-0 items-center gap-1 self-end text-xs font-semibold leading-none text-[#526277] underline-offset-2 transition hover:text-[#009FD9] hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#009FD9] sm:hidden"
                    >
