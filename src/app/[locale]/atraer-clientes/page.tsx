...
const TIPS: Tip[] = [
  {
    ...
    body: "Los clientes deciden en segundos si confiar en alguien. Una foto clara, bien iluminada y donde se vea tu cara genera mucha más confianza que un perfil sin foto o con una foto de poca calidad.",
    highlight: "Nada de fotos borrosas, con lentes oscuros, o de fiestas.",
  },
  {
    icon: <UserCheck className="h-6 w-6 text-[#009FD9]" />,
    title: "Verifica tu identidad",
    body: "La verificación confirma tu identidad con el Registro Civil de Costa Rica (no certifica la calidad de tu trabajo, pero sí demuestra que eres una persona real y verificable). Los perfiles verificados aparecen primero en los resultados y muestran el sello 'Identidad verificada'. Es gratis.",
    highlight: "Los perfiles verificados se muestran antes en las búsquedas.",
  },
  {
  ...
  },
  {
    ...
    body: "En Costa Rica la coordinación de servicios ocurre casi siempre por WhatsApp, y la gente espera respuestas rápidas. Si un cliente te escribe y tardas horas en responder, es probable que ya haya contactado a otro profesional. Activa las notificaciones y responde cuanto antes.",
  ...
  },
  {
    ...
    body: "Los clientes filtran por cantón. Si trabajas en Escazú, Belén y Santa Ana, menciónalo en tu bio. Si te desplazas por toda la Gran Área Metropolitana, dilo. Entre más claro seas sobre tu cobertura, más apareces en búsquedas relevantes.",
  },
  {
  ...
  },
  {
    ...
    body: "Si estás ocupado por dos semanas, márcalo en tu calendario. Los clientes que ven que estás disponible para la fecha que necesitan tienen muchas más probabilidades de contactarte. Un perfil con disponibilidad actualizada transmite profesionalismo.",
  },
];
            ...
            <div className="bg-white rounded-3xl border border-gray-100 p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-gray-600 leading-relaxed">
                <div>
                  ...
                  <p>En Costa Rica, la coordinación de servicios se hace mayormente por WhatsApp. No importa si estás en San José o Liberia — la gente espera poder escribirte por ahí y recibir respuesta rápida. Tener tu número de WhatsApp actualizado y activo es fundamental.</p>
                </div>
                <div>
      ...
      <section className="py-16 px-4 bg-[#1a2744] text-center">
        <FadeInUp>
          ...
          <p className="text-[#93c5fd] mb-8 max-w-md mx-auto text-sm">
            Completa tu perfil, verifica tu identidad, y empieza a aparecer en búsquedas hoy.
          </p>
