...
const ES_SECTIONS: LegalSection[] = [
  {
    ...
    body: [
      {
        k: "p",
        text: "El responsable del tratamiento de sus datos personales es **ContrataCR** (contratacr.com). Para cualquier asunto relacionado con sus datos, puede contactarnos en: **soporte@contratacr.com**",
      },
    ],
  },
  {
    ...
    body: [
      ...
      { k: "sub", text: "2.1 De todos los Usuarios" },
      {
        ...
        items: [
          ...
          "Datos básicos compartidos por Google cuando el Usuario se registra con ese proveedor.",
        ],
      },
      { k: "sub", text: "2.2 De los Clientes" },
      {
        k: "ul",
        items: [
          "Número de contacto para gestionar la cuenta y coordinar servicios cuando corresponda.",
          "Número de identificación, cuando lo proporciona al solicitar un servicio.",
          "Ubicación o zona, cuando la indica.",
          "Historial de solicitudes, publicaciones y profesionales guardados dentro de la Plataforma.",
        ],
      },
      { k: "sub", text: "2.3 De los Profesionales" },
      {
        k: "ul",
        items: [
          "Número de identificación (opcional; quienes lo aportan pueden obtener la insignia de identidad verificada).",
          "Nombre comercial o marca (opcional).",
          "Profesión(es) y servicios ofrecidos.",
          "Número de contacto y, opcionalmente, número para llamadas y correo de contacto.",
          "Ubicación: provincia, cantón y, opcionalmente, un punto en el mapa.",
          "Zonas de cobertura.",
          "Fotografía de perfil.",
          "Descripción, certificaciones en texto, fotografías de casos de éxito, aseguradoras con las que trabaja e idiomas.",
      ...
      {
        k: "ul",
        items: ["Información técnica básica generada por el uso de la Plataforma, necesaria para el funcionamiento del servicio."],
      },
      { k: "sub", text: "2.5 Verificación de identidad" },
      {
        k: "p",
        text: "Cuando un Usuario aporta su identificación, consultamos su validez contra registros oficiales para confirmar que el número es real y que el nombre coincide. **Almacenamos únicamente el resultado de esa verificación y el número de identificación de forma protegida**. Aplicamos el principio de minimización: no guardamos más datos de los necesarios.",
      },
    ],
  },
  {
    ...
    body: [
      {
        ...
        items: [
          ...
          "Permitir la conexión entre Clientes y Profesionales.",
      ...
      {
        k: "p",
        text: "**No vendemos sus datos personales.** No mostramos publicidad de terceros que pague por promocionarse dentro de las conversaciones o el contenido de la Plataforma.",
      },
    ],
  },
  {
    ...
    body: [
      {
        k: "p",
        text: "El perfil de un Profesional es público dentro de la Plataforma: su nombre o nombre comercial, profesión, servicios, ubicación general, descripción, fotografías, reseñas y la insignia de identidad verificada, si aplica, son visibles para los Clientes. Los datos sensibles, como el número completo de identificación, no se muestran públicamente.",
      },
    ],
  },
  {
    ...
    body: [
      {
        ...
        items: [
          ...
          "**Proveedores tecnológicos:** usamos servicios de terceros para alojamiento, imágenes, mapas, correo y funcionamiento de la Plataforma. Estos proveedores tratan datos siguiendo nuestras instrucciones.",
  ...
  },
  {
    ...
    body: [
      {
        k: "p",
        text: "Conservamos sus datos mientras su cuenta esté activa y durante el tiempo necesario para cumplir con las finalidades descritas o con obligaciones legales.",
      },
    ],
  },
  {
    ...
    body: [
      {
        k: "p",
        text: "Conforme a la Ley N.º 8968, usted tiene derecho a acceder, rectificar, cancelar o eliminar sus datos cuando proceda, y oponerse a ciertos tratamientos.",
      },
      { k: "p", text: "Para ejercer estos derechos, escríbanos a **soporte@contratacr.com**." },
    ],
  },
  {
    id: "seguridad",
    ...
    body: [
      {
        k: "p",
        text: "Aplicamos medidas técnicas y organizativas razonables para proteger sus datos, incluyendo cifrado, control de acceso y restricción de acceso a datos sensibles. Ningún sistema es completamente infalible, pero trabajamos para proteger su información.",
      },
    ],
  },
  {
    id: "menores",
    h: "9. Menores de edad",
    body: [{ k: "p", text: "ContrataCR está dirigido a personas mayores de 18 años. No recolectamos intencionalmente datos de menores de edad." }],
  },
  {
    id: "cambios",
    h: "10. Cambios a esta Política",
    body: [{ k: "p", text: "Podemos actualizar esta Política. Publicaremos los cambios en la Plataforma con la fecha de actualización." }],
  },
  {
    id: "contacto",
    h: "11. Contacto",
    body: [{ k: "p", text: "Para consultas sobre privacidad o para ejercer sus derechos, contáctenos en: **soporte@contratacr.com**" }],
  },
];
  ...
  return (
    <LegalDocument
      ...
      intro={en
        ...
        : "En ContrataCR respetamos su privacidad y protegemos sus datos personales conforme a la Ley N.º 8968 de Protección de la Persona frente al tratamiento de sus datos personales y su reglamento. Esta Política explica qué datos recolectamos, para qué los usamos y cuáles son sus derechos."}
