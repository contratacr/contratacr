                  ...
                  <div className={`grid gap-1.5 ${searchResults.length === 1 ? "max-w-[320px] grid-cols-1" : "grid-cols-1 sm:grid-cols-2 lg:grid-cols-3"}`}>
                    {searchResults.map(({ id, groupLabel }) => (
                      <Link
                        ...
                        className="group flex min-h-12 items-center justify-between gap-2 rounded-xl px-3 py-2 text-sm font-semibold leading-snug text-[#162543] transition-colors hover:bg-[#eaf6fc] hover:text-[#007fae]"
                      >
                      ...
                      <div className="grid grid-cols-1 gap-1.5 sm:grid-cols-2">
                        {activeGroup.ids.map((id) => (
                          <Link
                            key={id}
                            href={`/buscar?categoria=${id}`}
                            className="group flex min-h-10 items-center justify-between gap-2 rounded-xl px-3 py-2 text-sm font-semibold leading-snug text-[#162543] transition-colors hover:bg-[#eaf6fc] hover:text-[#007fae]"
                          >
