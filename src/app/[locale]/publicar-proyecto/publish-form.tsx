...
// Interactive publish-project form. Auth is enforced in the SERVER page wrapper
// (redirects unauthenticated users straight to /login BEFORE this renders), so
// there is no flash of the form for logged-out visitors.
