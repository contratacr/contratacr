...
const reviewed = new Map([
  ...
  ["src/components/reviews/pedir-resena-google.tsx", { count: 2, reason: "una marca por navegador para pedir la reseña de Google UNA sola vez en la vida de ese dispositivo; nada de la cuenta, y si el almacenamiento falla la tarjeta sale igual" }],
