...
const pageRules = [
  ...
  [/^\/\[locale\]\/(?:empleos|promociones)\/(?:publicar|\[id\]\/editar|mis-empleos|mis-promociones)$/, "marketplace-editors.spec.ts"],
  [/^\/\[locale\]\/(?:empleos|promociones)(?:\/|$)/, "marketplace-lifecycle.spec.ts"],
