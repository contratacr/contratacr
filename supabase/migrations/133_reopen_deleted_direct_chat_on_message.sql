-- A new direct message should bring the conversation back to the relevant inboxes,
-- even if a participant had previously deleted it from archived conversations.
